...
export const doctors: Doctor[] = [
  {
    ...
    reviewsCount: 312,
    reviews: [
      { user: "Anas", rating: 5, text: "Very thorough and reassuring. Explained everything clearly." },
      { user: "User#19022", rating: 5, text: "Best cardiologist I've consulted. Highly recommended." },
      { user: "User#77312", rating: 4, text: "Great doctor, clinic was a bit busy." },
    ],
    fee: 35,
    city: "Kuwait City",
    avatarSeed: "layla",
  ...
  },
  {
    ...
    reviewsCount: 198,
    reviews: [
      { user: "User#22301", rating: 5, text: "Cleared my acne in 3 months." },
      { user: "User#90234", rating: 4, text: "Professional and friendly staff." },
    ],
    fee: 22,
    city: "Salmiya",
    avatarSeed: "omar",
  ...
  },
  {
    ...
    reviewsCount: 421,
    reviews: [
      { user: "User#11023", rating: 5, text: "Amazing with kids, very patient." },
    ],
    fee: 18,
    city: "Hawalli",
    avatarSeed: "sarah",
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 254,
    reviews: [{ user: "User#55621", rating: 5, text: "Diagnosed quickly and accurately." }],
    fee: 40,
    city: "Kuwait City",
    avatarSeed: "karim",
    specialtyId: "neuro",
  ...
  },
  {
    ...
    rating: 4.85,
    reviewsCount: 167,
    reviews: [{ user: "User#30021", rating: 5, text: "Loved my new smile!" }],
    fee: 15,
    city: "Jabriya",
    avatarSeed: "nadia",
    specialtyId: "dental",
  ...
  },
  {
    ...
    rating: 4.75,
    reviewsCount: 142,
    reviews: [{ user: "User#90211", rating: 5, text: "Got me back to running in weeks." }],
    fee: 50,
    city: "Dubai",
    avatarSeed: "hassan",
    specialtyId: "ortho",
